...
| Terminus loop | original game composition | daemon/Ymir/Eve | pilot surface | Aetheria.Unity | partial live scenario proof: generic Unity discovers the provider, lowers the pilot world and assets, flies through Ymir, sees and collects daemon-authored salvage, pauses, queues targeting/fire, resumes, and presents the authoritative shot and receipts | destruction-created loot, dock, and trade remain before the minimum loop is proven |

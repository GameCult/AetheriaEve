...
| Shield/hull damage | energy-funded shield, armor cells, equipment and hull | daemon | entity status + damage events | meters, impacts, damage VFX | equipped Shield behavior now owns the fossil all-or-nothing energy gate: funded hits consume `damage * EnergyUsage`, add `damage / Efficiency` heat, and publish shield absorption without hull loss; unfunded hits bypass the shield; shot receipts expose exact shield/hull/energy/heat quantities and `effect.impact.shield` resolves through the provider asset manifest; fake or later Ymir contacts cannot decide damage | typed armor/hull/equipment grids, penetration, spread, damage types, and generic shield-effect lifecycle parity |

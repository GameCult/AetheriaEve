...
| AI/tasks | corporation task scheduler plus agent state machines | daemon | commander task board and shared semantic controls | Eve commander/pilot clients | explore and attack task execution wired through shared movement/target/fire commands; capability/priority assignment proven; remaining task families reference | original optimum-range control, mine/haul/tow/defend timelines, cancellation and reconnect |

    ...
    public static class AetheriaRuntimeDaemonGameSurfaceBuilder
    {
            ...
            AetheriaRuntimeCatalogSnapshot? catalog = null)
        {
            ...
            var surfaceChildren = new List<AetheriaRuntimeSurfaceComponent>
            {
                ...
                Hidden(Node(
                    ...
                    Metric("aetheria.daemon.game.player.lifecycle", "Run State", run.LifecyclePhase, AetheriaRuntimeDaemonStateRefs.CurrentRunLifecycle),
            ...
            AetheriaRuntimeCatalogSnapshot? catalog)
        {
            ...
            var props = new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                ["subjectVisible"] = AetheriaRuntimeRunLifecycle.IsActive(run) && !isDocked && playerEntityIndex >= 0 ? "true" : "false",
                ["movementEnabled"] = !AetheriaRuntimeRunLifecycle.IsActive(run) || isDocked ? "false" : "true",

...
namespace GameCult.Aetheria.State.Verse
{
    ...
    public static class AetheriaRuntimeEveSurfaceCatalog
    {
        ...
        private static readonly AetheriaRuntimeEveSurfaceAdvertisement[] Surfaces =
        {
            ...
            Surface(AetheriaRuntimeHangarCommands.SurfaceId, "Aetheria Hangar", AetheriaRuntimeVerseRecordKeys.HangarSurface.ToString(), "player", "Daemon-owned ship fitting and mode deployment launcher.", providerId: "aetheria.daemon", providerKind: "game.daemon", transport: "cultmesh-record", surfaceKind: "interactive-world", worldInteraction: WorldInteraction("provider-authored-world-surface"), requiresPlugins: FieldPluginRequirements()),

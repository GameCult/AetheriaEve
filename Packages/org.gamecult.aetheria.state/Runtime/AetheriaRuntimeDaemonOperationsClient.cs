        ...
        out AetheriaRuntimeDaemonCommandEnvelope? envelope)
    {
        ...
        envelope = kind switch
        {
            ...
            AetheriaRuntimeDaemonCommandKinds.TradeSale => client.TradeSale(
                ...
                (int)ReadPayloadDouble(request, "sourceX", int.MinValue),
                (int)ReadPayloadDouble(request, "sourceY", int.MinValue)),
            AetheriaRuntimeDaemonCommandKinds.TransferCargoItem => client.TransferCargoItem(
                frame,
                ReadPayloadString(request, "originEntityKey", ""),
                (int)ReadPayloadDouble(request, "originCargoIndex", -1),
                ReadPayloadString(request, "destinationEntityKey", ""),
                (int)ReadPayloadDouble(request, "destinationCargoIndex", -1),
                ReadPayloadString(request, "itemKey", ""),
                (int)ReadPayloadDouble(request, "quantity", 1),
                (int)ReadPayloadDouble(request, "sourceX", int.MinValue),
                (int)ReadPayloadDouble(request, "sourceY", int.MinValue),
                (int)ReadPayloadDouble(request, "destinationX", int.MinValue),
                (int)ReadPayloadDouble(request, "destinationY", int.MinValue),
                ReadPayloadBool(request, "hasDestinationPosition", false)),
            AetheriaRuntimeDaemonCommandKinds.EquipItem => client.EquipItem(
                frame,
                ReadPayloadString(request, "sourceKind", AetheriaRuntimeRefitSourceKinds.Cargo),
                ReadPayloadString(request, "originEntityKey", ""),
                (int)ReadPayloadDouble(request, "originIndex", -1),
                ReadPayloadString(request, "destinationEntityKey", ""),
                ReadPayloadString(request, "itemKey", ""),
                (int)ReadPayloadDouble(request, "sourceX", int.MinValue),
                (int)ReadPayloadDouble(request, "sourceY", int.MinValue),
                ...
                (int)ReadPayloadDouble(request, "destinationY", int.MinValue),
                ReadPayloadBool(request, "hasDestinationPosition", false)),
            AetheriaRuntimeDaemonCommandKinds.StoreItem => client.StoreItem(
                frame,
                ReadPayloadString(request, "originEntityKey", ""),
                (int)ReadPayloadDouble(request, "originIndex", -1),
                ReadPayloadString(request, "destinationEntityKey", ""),
                ...
                (int)ReadPayloadDouble(request, "destinationY", int.MinValue),
                ReadPayloadBool(request, "hasDestinationPosition", false),
                ReadPayloadString(request, "sourceKind", AetheriaRuntimeRefitSourceKinds.Equipment)),

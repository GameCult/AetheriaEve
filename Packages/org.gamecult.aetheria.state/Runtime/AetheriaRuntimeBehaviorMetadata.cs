    ...
    public static class AetheriaRuntimeBehaviorMetadataCatalog
    {
        ...
        private static readonly IReadOnlyDictionary<string, AetheriaRuntimeBehaviorMetadata> ByKind =
            new[]
            {
                ...
                Behavior(AetheriaRuntimeBehaviorKinds.DeployableWeapon, AetheriaRuntimeBehaviorKinds.InstantWeapon,
                    With(InstantWeaponFields, Number("ActivationDelay", 26), Number("Lifetime", 27),
                        Stat("TriggerRadius", 28), Number("DetonationDelay", 29), Stat("BlastRadius", 30))),

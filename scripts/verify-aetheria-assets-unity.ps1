...
$surfaceRef = "https://github.com/GameCult/Eve.git?path=/packages/org.gamecult.eve.surface#3ede0799abde0bf21a4b691d99dae73ce2294f4b"
...
if ($manifest.dependencies.'org.gamecult.eve.surface' -ne $surfaceRef -or
    ...
    $lock.dependencies.'org.gamecult.eve.surface'.hash -ne '3ede0799abde0bf21a4b691d99dae73ce2294f4b') {
...
$requiredStateDependencies = @{
  ...
  'org.gamecult.eve.surface' = '0.3.5'
}

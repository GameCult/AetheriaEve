...
assert.ok(advertisement.surfaces.some((surface) => surface.surfaceId === "aetheria.daemon.game" && surface.worldInteraction?.projectionKind === "provider-authored-world-surface"));

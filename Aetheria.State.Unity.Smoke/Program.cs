...
try
{
    ...
    await using (var commitNode = await AetheriaStateNode.OpenAsync(commitSmokeStatePath, "aetheria-unity-runtime-commit-smoke"))
    {
        ...
        typedNodeApplied = report.AppliedPlayerSettings == 1 &&
            ...
            entity.Equipment[0].OverrideShutdown &&
            ...
            entity.BehaviorStates.Length == 15 &&
            ...
            entity.BehaviorStates[5].ResourceScannerTargetBodyKey == "aetheria.body:legacy:smoke:body" &&
            ...
            entity.BehaviorStates[6].MiningToolAsteroidBeltKey == "aetheria.body:legacy:smoke:body" &&
            ...
            entity.BehaviorStates[13].BehaviorKind == "StatModifier" &&
            entity.BehaviorStates[13].StatModifierApplied &&
            entity.BehaviorStates[13].StatModifierExecuted &&
            entity.BehaviorStates[13].StatModifierTargetStatCount == 2 &&
            entity.BehaviorStates[14].BehaviorKind == "TurretController" &&
            entity.BehaviorStates[14].TurretControllerWeaponCount == 2 &&
            entity.BehaviorStates[14].TurretControllerShotSpeed == 80.0 &&
            entity.BehaviorStates[14].TurretControllerPredictShots &&
    ...
    if (!typedNodeApplied ||
        ...
        !packageLoadouts[0].RootEntity.Equipment[0].Item.OverrideShutdown ||
        ...
        !packageEntities[0].Equipment[0].OverrideShutdown ||
        ...
        packageEntities[0].BehaviorStates.Count != 15 ||
        ...
        packageEntities[0].BehaviorStates[5].ResourceScannerTargetBodyKey != "aetheria.body:legacy:smoke:body" ||
        packageEntities[0].BehaviorStates[5].ResourceScannerScanDuration != 3.5 ||
        packageEntities[0].BehaviorStates[6].MiningToolAsteroidBeltKey != "aetheria.body:legacy:smoke:body" ||
        ...
        !packageEntities[0].BehaviorStates[13].StatModifierApplied ||
        packageEntities[0].BehaviorStates[13].StatModifierTargetStatCount != 2 ||
        packageEntities[0].BehaviorStates[14].TurretControllerWeaponCount != 2 ||
        packageEntities[0].BehaviorStates[14].TurretControllerShotSpeed != 80.0 ||
        !packageEntities[0].BehaviorStates[14].TurretControllerPredictShots ||

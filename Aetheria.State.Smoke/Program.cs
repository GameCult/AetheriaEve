    ...
    await node.PutEntitySnapshotAsync(entityKey, new AetheriaEntitySnapshot
    {
        ...
        [
            ...
            new AetheriaBehaviorStateSnapshot
            {
                ...
                ResourceScannerTargetBodyId = "aetheria.body:legacy:smoke:body",
            ...
            new AetheriaBehaviorStateSnapshot
            {
                ...
                MiningToolAsteroidBeltId = "aetheria.body:legacy:smoke:body",
...
await using (var reopened = await AetheriaStateNode.OpenAsync(statePath, "aetheria-state-smoke-reopen"))
{
    ...
    if (entitySnapshot?.Kind != "ship" ||
        ...
        entitySnapshot.BehaviorStates[1].ResourceScannerTargetBodyId != "aetheria.body:legacy:smoke:body" ||
        ...
        entitySnapshot.BehaviorStates[2].MiningToolAsteroidBeltId != "aetheria.body:legacy:smoke:body" ||
